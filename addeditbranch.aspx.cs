...
public partial class addeditbranch : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            if (Request.QueryString["id"] != null)
            {
                ...
                btnSave.Text = "Update";
                hPageTitle.InnerText = "Branch Update";
                Page.Title = "Branch Update";
            }
            else
            {
                hPageTitle.InnerText = "New Branch";
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if (Result > 0)
            {
                ...
                Response.Redirect(Page.ResolveUrl("~/managebranches.aspx?mode=i"));
            }
            else
            {
                Clear();
    ...
    {
        Response.Redirect(Page.ResolveUrl("~/managebranches.aspx"));
    }
