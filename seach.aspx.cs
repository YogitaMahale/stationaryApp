...
public partial class _Default : System.Web.UI.Page
{
   ...
   // int pos;
    ...
    private void Bindsubcategory(Int64 maincategory)
    {
         
        DataTable dt = (new cls_subcategory_b().SelectAll(maincategory));
    ...
    private void BindDataIntoArrivalRepeater(Int64 maincategoryid)
    {
        ...
        try
        {
            ...
            {
                subcategoryid = Convert.ToInt64(ddlsubcategory.SelectedValue.ToString());
            }
        ...
        _pgsource.DataSource = ds.DefaultView;
