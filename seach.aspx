<%@ Page Title="" Language="C#" MasterPageFile="~/websitemaster.master" AutoEventWireup="true" CodeFile="seach.aspx.cs" Inherits="_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="padding-top-100 padding-bottom-100">
                ...
                <table class="table table-hover">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 10%">Subcategory :
                                <asp:DropDownList ID="ddlsubcategory" class="browser-default custom-select" AutoPostBack="true" OnSelectedIndexChanged="ddlsubcategory_SelectedIndexChanged" runat="server">
                                </asp:DropDownList>
                            </th>

                            <%--  <th style="width: 10%">
                                Type :
                                <asp:DropDownList ID="ddltype" class="browser-default custom-select" runat="server">
                            ...
                            <th style="width: 10%">
                                Brand :
                                <asp:DropDownList ID="ddlbrand" class="browser-default custom-select" runat="server">
        ...
        <div class="arrival-block" id="divRepeaterNewArrival">
            <div class="row">
                ...
                <div class="col-md-2">
                    <div class="some-info">
                              <ul class="col-sm-12">
                                                <li><a href="shop_01.html">test1</a></li>
                                                <li><a href="shop_01.html">test1</a></li>
                                   <li><a href="shop_01.html">test1</a></li>
                                   <li><a href="shop_01.html">test1</a></li>
        ...
        <div style="margin-top: 20px; text-align: center; margin-left: 500px; margin-right: 300px;">
    ...
    <script>
        $("a[href='search.aspx']").attr("id", "active");
