<%@ Page Title="" Language="C#" MasterPageFile="~/superadmin.master" AutoEventWireup="true" CodeFile="manageWebsiteSlider.aspx.cs" Inherits="manageWebsiteSlider" %>
                ...
                <div class="col-xs-12">
                    ...
                    <div class="box box-success">
                        ...
                        <div class="box-header">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 text-right">
                                                                                                <asp:Button ID="btnNewCategoty" runat="server" Text="Add New" class="btn btn-success" OnClick="btnNewCategoty_Click" />
                            </div>
