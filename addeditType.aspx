<%@ Page Title="" Language="C#" MasterPageFile="~/superadmin.master" AutoEventWireup="true" CodeFile="addeditType.aspx.cs" Inherits="addeditType" %>
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <asp:DropDownList ID="ddlsubcategory" Class="form-control" Width="500px" runat="server"></asp:DropDownList>
                    ...
                    <div class="form-group">
                        ...
                        <asp:RequiredFieldValidator ID="RFVtxtCategoryName" runat="server" Display="Dynamic" ControlToValidate="txtType" CssClass="error" ErrorMessage="Required Field" ValidationGroup="c1"></asp:RequiredFieldValidator>
                    </div>
