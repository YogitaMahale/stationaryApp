<%@ Page Title="" Language="C#" MasterPageFile="~/superadmin.master" AutoEventWireup="true" CodeFile="manageCountry.aspx.cs" Inherits="manageCountry" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <div style="text-align: right">
        <asp:Button ID="btnNewCompany" runat="server" Text="Add New Country" CssClass="btn btn-danger" OnClick="btnNewCompany_Click" />
    </div>
                ...
                <ItemTemplate>
                    <tr>
                        <td style="text-align: center">
                            ...
                            <asp:Label ID="lblCompanyName" runat="server" Text='<%# Eval("countrycode") %>'></asp:Label>
                        </td>  
                      
                        
                           <td style="text-align: center">
                                <asp:Label ID="lblbank"  runat="server" Text='<%# Eval("countryname") %>'></asp:Label>
                            </td>                      
