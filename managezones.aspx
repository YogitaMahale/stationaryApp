<%@ Page Title="" Language="C#" MasterPageFile="~/superadmin.master" AutoEventWireup="true" CodeFile="managezones.aspx.cs" Inherits="managezones" %>
                                    ...
                                    <asp:Repeater ID="repCategory" runat="server" OnItemDataBound="repCategory_ItemDataBound">
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td style="text-align: center">
                                                    <asp:Label ID="lblzonename" runat="server" Text='<%# Eval("name") %>'></asp:Label>
                                                </td>
