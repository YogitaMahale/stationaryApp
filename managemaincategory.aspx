<%@ Page Title="" Language="C#" MasterPageFile="~/superadmin.master" AutoEventWireup="true" CodeFile="managemaincategory.aspx.cs" Inherits="managecategory" %>
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <div style="text-align: right;">
                                <asp:Button ID="btnNewCategoty" runat="server" Text="New MainCategory" class="btn btn-Normal btn-primary" OnClick="btnNewCategoty_Click" Width="150" />
                            </div>
                            <br />
