...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="ecommercetemp/rs-plugin/css/settings.css" media="screen" />

    <!-- Bootstrap Core CSS -->
    <link href="ecommercetemp/css/bootstrap.min.css" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="ecommercetemp/css/font-awesome.min.css" rel="stylesheet" type="text/css">
    <link href="ecommercetemp/css/ionicons.min.css" rel="stylesheet">
    <link href="ecommercetemp/css/main.css" rel="stylesheet">
    <link href="ecommercetemp/css/style.css" rel="stylesheet">
    <link href="ecommercetemp/css/responsive.css" rel="stylesheet">
                ...
                <div class="sticky">
                    <div class="container">
                        ...
                        <div class="logo"><a href="index.html">
                            <img class="img-responsive" src="ecommercetemp/images/logo.png" alt=""></a> </div>
                                                    ...
                                                    <div class="top-rated">
                                                        <ul>
                                                            ...
                                                            <li>
                                                                <div class="media-left">
                                                                    <div class="cart-img"><a href="#">
                                                                        <img class="media-object img-responsive" src="images/cart-img-3.jpg" alt="...">
                                                                    </a></div>
                                                                </div>
                                                                <div class="media-body">
          ...
          Sed feugiat, tellus vel tristique posuere, diam</span>
                    ...
                    <div class="arrival-block">
                        ...
                        <div class="item">
                            ...
                            <img class="img-2" src="images/item-img-1-1-1.jpg" alt="">
                            <!-- Overlay  -->
                            <div class="overlay">
                                <!-- Price -->
                        ...
                        <div class="papular-block block-slide">
                            ...
                            <div class="item">
                                ...
                                <div class="item-img">
                                    ...
                                    <img class="img-2" src="images/product-2.jpg" alt="">
                                    <!-- Overlay -->
                                    <div class="overlay">
                                        <div class="position-center-center">
                ...
                <section class="testimonial padding-top-100">
                    <div class="container">
                        <div class="row">
                            ...
                            <!-- Img -->
                            <div class="col-sm-6">
                                <img class="img-responsive" src="images/testi-avatar.jpg" alt="">
                            </div>
                        </div>
                    </div>
                </section>
